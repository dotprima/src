...
$(document).ready(function () {
     ...
     $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "https://cdn.statically.io/gh/dotprima/src/main/tubes/assets/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', 'https://cdn.statically.io/gh/dotprima/src/main/tubes/assets/images/logo/logo.png');
